package com.memoko.integrated.socialapi.service;
...
public class NaverLogin {
    ...
    private final static String CLIENT_ID = "FiGHjiGU7Edy8pf_DR2t";
    private final static String CLIENT_SECRET = "eFPoexxYlX";
    private final static String REDIRECT_URI = "http://localhost:8888/socialapi/naverLogin";
